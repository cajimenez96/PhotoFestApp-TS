...
const Camera = () => {
  ...
  return (
    <View style={globalStyles.container}>
      <CameraView mode={mode} style={[globalStyles.container, globalStyles.padding, { flex: 1 }]} facing={facing} ref={cameraRef} flash={flash} enableTorch={mode === "video" && flash === "on" && true}>
